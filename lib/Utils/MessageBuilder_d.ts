 ...
 * /areas/jap-baileys.md), not a public spec, so treat this as best-effort autocomplete
...
// Same class as AIRich — exported under alternate names (see JAP@Alias in
// MessageBuilder.js). All four are structurally identical to AIRich.
export { AIRich as AIJap, AIRich as LeafRich, AIRich as JapAI, AIRich as JapRich };
