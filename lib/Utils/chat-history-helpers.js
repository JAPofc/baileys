/**
 * JAP@Add --- part of the @japofc/baileys utils (chat-history-helpers.ts.)
 *
 * NOTE: this was written against this package's own
 * `in-memory-store.ts` addon (a plain `Map<jid, WAMessage[]>`), which this fork
 * does not have. `@japofc/baileys` already ships a full `makeInMemoryStore`
