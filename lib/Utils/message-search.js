// JAP@Add --- part of the @japofc/baileys utils (message-search.ts) (type-only
// annotations dropped; behavior unchanged).
// JAP@Fix (bug 58): peel off ephemeral / view-once wrappers so search still
...
export const searchMessages = (messages, query, options = {}) => {
    ...
    for (const message of messages) {
        ...
        // JAP@Fix (bug 59): limit used to break the scan loop *before* sorting,
