/**
 * JAP@Add --- part of the @j.ap/baileys utils (stickerpack.ts.)
 *
...
export const prepareStickerPackMessage = async (message, options) => {
    ...
    const { cover, stickers = [], name = '📦 Sticker Pack', publisher = 'GitHub: JAPofc', description = '🏷️ j.ap/baileys', packId } = message;
