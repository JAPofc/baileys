...
import defaultLogger from './logger.js'; // JAP@Fix: replace raw console.error
...
export const useCacheManagerAuthState = async (store, sessionKey) => {
    ...
    const removeData = async (file) => {
        try {
            ...
            defaultLogger.error({ err, file, sessionKey }, 'useCacheManagerAuthState: error removing key'); // JAP@Fix
        }
    };
