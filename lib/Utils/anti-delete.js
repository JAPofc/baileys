// JAP@Add --- part of the @japofc/baileys utils (anti-delete.ts) (adapted to lib/ CJS-free ESM
...
export class MessageStore {
    ...
    markAsDeleted(key, deletedBy) {
        ...
        // JAP@Fix (bug 66): the old check (`deletedBy === stored.message.key.participant`)
...
/**
 * JAP@Fix (bug 58): `createAntiDeleteHandler` above only listens on
